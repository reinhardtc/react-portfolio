			...
			<div id="container">
				<div className="img-text-box col">
					...
					<div className="my-2 margin-block col-lg-8">
						<p>
							My name is Colin Reinhardt. I'm a full stack web developer based in Austin, Texas.
							Previously, I've worked in tech customer service for 10 years. I studied classical singing in
							College, but found that I also had a great interest in learning about new and exciting
							technology. If you have any questions about my experience, projects, or me, I'd love to hear
							from you!
						</p>
